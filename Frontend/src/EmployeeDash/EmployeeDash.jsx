    ...
    <div className="h-screen ">
      <div className="md:flex">
        <div className="flex flex-col">
          <div
            className="flex sm:flex-row flex-col justify-between p-4 h-[450px]  bg-cover  max-h-screen "
            style={{ backgroundImage: `url(${dashgroup})` }}
          >
            <div className="bg-navy-500 text-lightPrimary bg-opacity-40 p-2 md:w-1/4 h-1/4 shadow-md rounded-md mb-4">
            ...
            <div className="bg-navy-500 text-lightPrimary flex flex-col  p-2 shadow-md rounded-md mb-4 md:h-1/2 md:w-2/5 bg-opacity-30">
          ...
          <div className="md:flex gap-1 mt-30">
              ...
              <ul className="list-none">
                {bulletinItems.map((item) => (
                  <li key={item.id} className="mb-4">
                    ...
                    <p className="text-navy-500 mb-1">Date: {item.date}</p>
                    <p className="text-navy-800">{item.description}</p>
                  </li>
                ))}
              </ul>
            </div>
