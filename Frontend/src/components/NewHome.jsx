  ...
  return (
    ...
    {/* navigation bar ended     */}
      ...
      <div className="flex flex-col sm:flex-row mt-4 m-4 justify-between text-white text-lg">
        <div className="box  w-1/3 bg-gray-200 h-80 mr-20 ml-20 shadow-2xl  border-gray-200"><div className="inner-box font-calibri  bg-cyan-700 p-2 hover:mt-4 hover:mb-4 hover:ml-4  h-full overflow-hidden">Our employee management software helps you efficiently manage your workforce, automate tasks, and boost productivity. With our intuitive interface, you can easily create and manage teams, add employees, and organize them according to departments, projects, or roles.</div></div>
        <div className="box  w-1/3 bg-gray-200 h-80 mr-20 ml-20 shadow-2xl  border-gray-200"><div className="inner-box font-calibri  bg-cyan-700 p-2 hover:mt-4 hover:mb-4 hover:ml-4  h-full overflow-hidden">Simplify the employee onboarding process by centralizing all employee data in one place. Track employee progress, manage training programs, and monitor performance evaluations. Our software also allows you to assign projects, tasks, and deadlines to individual employees or teams, ensuring efficient project management.</div></div>
        <div className="box  w-1/3 bg-gray-200 h-80 mr-20 ml-20 shadow-2xl  border-gray-200"><div className="inner-box font-calibri  bg-cyan-700 p-2 hover:mt-4 hover:mb-4 hover:ml-4  h-full overflow-hidden">Faster collaboration within your organization with built-in communication and collaboration tools. Employees can exchange messages, share files, and collaborate on projects directly within the software. Stay updated with real-time notifications, task progress, and project status. Additionally, our software provides comprehensive reporting and analytics, giving you insights into employee performance, project timelines, and resource allocation.</div></div>
      </div>
