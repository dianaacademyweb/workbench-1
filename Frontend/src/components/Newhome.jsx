  ...
  return (
    ...
    {/* navigation bar ended */}
      ...
      <div className="flex flex-col sm:flex-row mt-4 m-4 justify-between text-white text-lg">
        <div className="box w-1/3  bg-gray-200 h-80 ml-8 shadow-2xl border border-gray-400"><div className="inner-box  font-calibri   p-2  text-justify h-full ">employee management software helps you efficiently manage your workforce, automate tasks, and boost productivity. With our intuitive interface, you can easily create and manage teams, add employees, and organize them according to departments, projects, or roles</div></div>
        <div className="box w-1/3  bg-gray-200 h-80 ml-10 shadow-2xl border border-gray-400"><div className="inner-box   font-calibri   p-2 text-justify  h-full ">Simplify the employee onboarding process by centralizing all employee data in one place. Track employee progress, and monitor performance evaluations. Our software also allows you to assign projects, tasks, and deadlines to individual employees or teams</div></div>
        <div className="box w-1/3  bg-gray-200 h-80 ml-10 mr-8 shadow-2xl border border-gray-400"><div className="inner-box   font-calibri  p-2   text-justify h-full ">Faster collaboration within your organization with built-in communication and collaboration tools. Employees can exchange messages, share files, and collaborate on projects directly within the software. Stay updated with real-time notifications,and project status</div></div>
      </div>
