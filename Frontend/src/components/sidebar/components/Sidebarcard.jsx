...
function SidebarCard() {
  return (
    <div>
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#05072c] via-[#09090b] to-brand-700 pb-4">
  <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white bg-gradient-to-b from-[#101010] to-brand-500 dark:!border-navy-800">
    <svg
      width="41"
      height="41"
      viewBox="0 0 41 41"
  ...
  <div className="mt-16 flex h-fit flex-col items-center">
    ...
    <p className="mt-1 px-4 text-center text-sm text-white">
      Improve your process with work warden 
    </p>
  </div>
</div> 
