...
function Administration(){
  const cardData = [
    ...
    { image: '/src/assets/Images/layouts/pro.jpg', name: 'Alex Johnson', designation: 'Secretary' },
    { image: '/src/assets/Images/layouts/pro.jpg', name: 'Sarah Thompson', designation: 'Receptionist' },
    { image: '/src/assets/Images/layouts/pro.jpg', name: 'Michael Brown', designation: 'Staff Representative' }
  ];
  return (
    <div className="bg-cover " style={{ backgroundImage: `url(${home})` }}>
      ...
      <div className="grid grid-cols-5 grid-rows-2 gap-4 ">
        ...
        <div className="card col-start-2 row-start-2 bg-white flex flex-col items-center justify-center rounded shadow">
        ...
        <div className="card col-start-3 row-start-2 bg-white flex flex-col items-center justify-center rounded shadow">
        ...
        <div className="card col-start-4 row-start-2 bg-white flex flex-col items-center justify-center rounded shadow">
        ...
        <div className="card col-start-5 row-start-2 bg-white flex flex-col items-center justify-center rounded shadow">
