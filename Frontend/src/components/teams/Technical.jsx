  ...
  return (
    <div className="bg-cover " style={{ backgroundImage: `url(${home})` }}>
      ...
      <div className="grid grid-cols-4 grid-rows-3 gap-4">
        <div className="card col-start-2 bg-white flex flex-col items-center justify-center rounded shadow">
        ...
        <div className="card  row-start-2 bg-white flex flex-col items-center justify-center rounded shadow">
          ...
          <div className="card  row-start-3 bg-white flex flex-col items-center justify-center rounded shadow">
          ...
          <div className="card  row-start-3 bg-white flex flex-col items-center justify-center rounded shadow">
          <img src={cardData[7].image} alt="Profile" className="w-32 h-32 rounded-full mb-4" />
          <h3 className='text-xl font-semibold mb-2'>{cardData[7].name}</h3>
          <p className="text-gray-600">{cardData[7].designation}</p>
          </div>
        </div>
      </div>
      </div>
