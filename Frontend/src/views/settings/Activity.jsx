    ...
    <div>
      ...
      <div className='bg-white text-lightPrimary dark:bg-navy-900 m-4 min-h-screen rounded-3xl'>
        <div className='p-6'>
            ...
            className="p-2 flex h-full w-full rounded-full  bg-white text-sm font-medium text-navy-700 outline-none placeholder:!text-gray-400 dark:bg-navy-900  dark:placeholder:!text-white sm:w-fit border border-navy-500"
          />
          </div>
          <div class="flex flex-col">
  <div class="overflow-x-auto sm:-mx-6 lg:-mx-8 text-lightPrimary">
