  ...
  return (
    <div>
      ...
      <div className='bg-white m-4 p-4 rounded-3xl max-h-screen flex flex-col'>
            ...
            <p className='pb-4'>Get Company wide report on employee activities, dormant employees and more.</p>
            <div className='flex p-5 items-center mx-24 justify-around shadow'>
                <div className='flex'>
                <input type="radio"/>
                <span className='font-bold'>DAILY</span>
                <p className='pl-10 flex text-right text-gray-700'>Get report every day</p>
                </div>
            </div>
      </div>
    </div>
