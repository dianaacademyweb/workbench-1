  ...
  return (
    <div>
        ...
        <label className="dark:text-white dark:bg-navy-900 m-2">
          ...
          <label className="dark:text-white dark:bg-navy-900 m-2">End Date:
            ...
            <tbody>
              {attendanceReport.map((record) => (
                <tr key={record.date}>
                  ...
                  <td class="border px-4 py-2">{record.login_time}</td>
                </tr>
              ))}
            </tbody>
          </table>
            ...
            <tbody>
              {logoutreport.map((logoutrecords) => (
                <tr key={logoutrecords.date}>
                  <td class="border px-4 py-2">{logoutrecords.date}</td>
                  <td class="border px-4 py-2">{logoutrecords.logout_time}</td>
                  <td class="border px-4 py-2">{logoutrecords.endreport}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <table className="min-w-full text-left text-sm font-light">
          <thead className="border-b font-medium dark:border-neutral-500">
            <tr>
              ...
              <th scope="col" className="px-6 py-4">Off Days</th>
              <th scope="col" className="px-6 py-4">Total Active Hours</th>
              <th scope="col" className="px-6 py-4">Avg Hours</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b dark:border-neutral-500">
              ...
              <td className="whitespace-nowrap px-6 py-4">active hours</td>
